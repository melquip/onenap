			...
			<div className="animated fadeIn">
				<div className="card">
					...
					<div className="card-body">
						<p>Documentation and examples for Bootstrap typography, including global settings, headings,
				...
				<div className="card">
					...
					<div className="card-body">
						<p>Traditional heading elements are designed to work best in the meat of your page content. When
							you need a heading to stand out, consider using
				...
				<div className="card">
					...
					<div className="card-body">
						<p>Align terms and descriptions horizontally by using our grid system’s predefined classes (or
							...
							optionally add a <code className="highlighter-rouge">.text-truncate</code> class to truncate
							...
							<dl className="row">
								...
								<dd className="col-sm-9">
									<dl className="row">
										...
										<dd className="col-sm-8">Aenean posuere, tortor sed cursus feugiat, nunc augue
											blandit nunc.
										</dd>
									</dl>
								</dd>
