						...
						<Card>
							<CardHeader>
								...
								<div className="card-header-actions">
									<a href="https://reactstrap.github.io/components/alerts/" rel="noreferrer noopener"
					...
					<Col xs="12" md="6">
						<Card>
							...
							<CardBody>
								...
								<Alert color="danger">
									This is a danger alert with <a href="#" className="alert-link">an example link</a>.
									Give it a click if you like.
								</Alert>
								<Alert color="warning">
								...
								<Alert color="light">
									This is a light alert with <a href="#" className="alert-link">an example link</a>.
									Give it a click if you like.
								</Alert>
								<Alert color="dark">
							...
							<CardBody>
								<Alert color="success">
									...
									<p>
										...
										is going
										to run a bit longer so that you can see how spacing within an alert works with
										this kind
										of content.
									</p>
									<hr/>
