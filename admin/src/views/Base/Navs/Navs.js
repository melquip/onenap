				...
				<Card>
					<CardHeader>
						...
						<div className="card-header-actions">
							<a href="https://reactstrap.github.io/components/navs/" rel="noreferrer noopener"
					...
					<CardBody>
						...
						<Nav>
							...
							Link</NavLink> <NavLink disabled href="#">Disabled
							Link</NavLink>
						</Nav>
					</CardBody>
				</Card>
				<Card>
					...
					<CardBody>
						<Nav tabs>
							...
							<Dropdown nav isOpen={this.state.dropdownOpen[0]} toggle={() => {
								this.toggle(0);
							}}>
				...
				<Card>
					...
					<CardBody>
						<Nav pills>
							...
							<Dropdown nav isOpen={this.state.dropdownOpen[1]} toggle={() => {
								this.toggle(1);
							}}>
								<DropdownToggle nav caret>
									Dropdown
