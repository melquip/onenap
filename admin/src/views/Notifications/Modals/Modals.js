					...
					<Col>
						<Card>
							...
							<CardBody>
								...
								<Button color="primary" onClick={this.togglePrimary} className="mr-1">Primary
									modal</Button>
								...
								<Button color="success" onClick={this.toggleSuccess} className="mr-1">Success
									modal</Button>
								...
								<Button color="warning" onClick={this.toggleWarning} className="mr-1">Warning
									modal</Button>
								...
								<Button color="danger" onClick={this.toggleDanger} className="mr-1">Danger
									modal</Button>
