						...
						<Nav tabs>
							<NavItem>
								...
								>
									...
									className={this.state.activeTab === '1' ? '' : 'd-none'}> Calculator</span>
								</NavLink>
							</NavItem>
							<NavItem>
								<NavLink
							...
							<NavItem>
								...
								>
									...
									className={this.state.activeTab === '3' ? '' : 'd-none'}> Charts</span>
								</NavLink>
							</NavItem>
						</Nav>
						<TabContent activeTab={this.state.activeTab}>
					...
					<Col xs="12" md="6" className="mb-4">
						<Nav tabs>
							<NavItem>
								...
								>
									<i className="icon-calculator"></i> <span
									className={this.state.activeTab === '1' ? '' : 'd-none'}> Calculator </span>{'\u00A0'}<Badge
							...
							<NavItem>
								...
								>
									<i className="icon-basket-loaded"></i> <span
									className={this.state.activeTab === '2' ? '' : 'd-none'}> Shopping cart </span>{'\u00A0'}<Badge
									pill color="danger">29</Badge>
								</NavLink>
							</NavItem>
							<NavItem>
								<NavLink
